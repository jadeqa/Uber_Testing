...
// TC06: Lead conversion with existing PL and Group account - error validation
test('TC06: Lead conversion with existing PL and Group account - error validation', async ({ page }) => {
